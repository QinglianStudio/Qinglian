...
var buildLogFactory = function (level) {
    ...
    return function () {
        ...
        console.log.apply(console, __spreadArray(["".concat(color("".concat((0, ansi_colors_1.bold)(symbol_1.SYMBOL.DOT), " Qinglian ").concat(level, " [").concat((0, dayjs_1.default)().format("YYYY-MM-DD HH:mm:ss"), "]: ")))], params, false));
    };
};
var Log = {
